...
export default function OneReceived({ friend }: OneLinkProps) {
  return (
    <div className="rounded-lg shadow border-2 border-amber-100 bg-slate-700 p-2 flex items-center justify-between hover:bg-slate-600 transition-colors duration-300">
      <div className="text-2xl p-2 pl-0 text-green-300 hover:text-green-500 cursor-pointer transition-colors duration-300">
        <TiUserAdd />
      </div>
